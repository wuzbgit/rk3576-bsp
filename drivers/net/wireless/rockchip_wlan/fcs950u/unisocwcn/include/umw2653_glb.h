...
#define MARLIN3E_AA_CHIPID	MARLIN_3E_CHIPID
...
/*For INTC soft irq replace AP PUB_INT CP*/
#define REG_AON_INTC_SOFTIRQ 0x4061c010
...
/*fixed addr defined in wcn_sync_info_t by cp*/
#define SYNC_CP_ACK_AP_VALUE_ADDR (SYNC_ADDR+0x4)
#define SYNC_AP_INT_CP_REQ_ADDR (SYNC_ADDR+0x8)
#define SYNC_WIFI_USED_SECTIONS_ADDR (SYNC_ADDR+0xc)
#define SYNC_BT_USED_SECTIONS_ADDR (SYNC_ADDR+0x10)
#define SYNC_MEM_PD_SYNC_FLAG (SYNC_ADDR+0x24)
#define SYNC_BT_BEGIN_ADDR (SYNC_ADDR+0x28)
#define SYNC_WIFI_BEGIN_ADDR (SYNC_ADDR+0x50)
