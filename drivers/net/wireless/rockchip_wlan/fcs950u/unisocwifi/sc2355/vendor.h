...
enum sprdwl_softap_sae_type {
	SPRDWL_VENDOR_SAE_INVALID = 0,
	SPRDWL_VENDOR_SAE_ENTRY = 1,
	SPRDWL_VENDOR_SAE_PASSWORD = 2,
	SPRDWL_VENDOR_SAE_IDENTIFIER = 3,
	SPRDWL_VENDOR_SAE_PEER_ADDR = 4,
	SPRDWL_VENDOR_SAE_VLAN_ID = 5,
	SPRDWL_VENDOR_SAE_GROUP_ID = 6,
	SPRDWL_VENDOR_SAE_ACT = 7,
	SPRDWL_VENDOR_SAE_PWD = 8,
	SPRDWL_VENDOR_SAE_END = 0xFF,
	SPRDWL_VENDOR_SAE_MAX = SPRDWL_VENDOR_SAE_PWD,
};
#else
enum sprdwl_softap_sae_type {
...
#if (KERNEL_VERSION(4, 20, 0) <= LINUX_VERSION_CODE)
static const struct
nla_policy vendor_sae_policy[SPRDWL_VENDOR_SAE_MAX + 1] = {
#else
static const struct
nla_policy vendor_sae_policy[SPRDWL_VENDOR_SAE_END + 1] = {
#endif
	[SPRDWL_VENDOR_SAE_ENTRY] = { .type = NLA_NESTED },
	[SPRDWL_VENDOR_SAE_PASSWORD] = { .type = NLA_STRING },
	[SPRDWL_VENDOR_SAE_IDENTIFIER] = { .type = NLA_STRING },
	[SPRDWL_VENDOR_SAE_PEER_ADDR] = { .type = NLA_STRING },
	[SPRDWL_VENDOR_SAE_VLAN_ID] = { .type = NLA_U32 },
	[SPRDWL_VENDOR_SAE_GROUP_ID] = { .type = NLA_STRING },
	[SPRDWL_VENDOR_SAE_ACT] = { .type = NLA_U32 },
	[SPRDWL_VENDOR_SAE_PWD] = { .type = NLA_STRING },
};
